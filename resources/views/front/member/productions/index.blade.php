                ...
                <div class="col-lg-9 col-md-12 col-12">
                    <div class="card border-0 shadow-sm rounded-lg overflow-hidden">
                        <div
                            ...
                            <a href="{{ route('member.productions.create') }}"
                                                ...
                                                @if($production->admin_note)
                                                    <div class="mt-1">
                                                        <small class="text-danger font-weight-bold"
                                                               style="cursor: help;" title="Une note a été ajoutée">
                                            ...
                                            <td class="align-middle text-center">
                                                <div class="btn-group">
                                                    <button type="button"
                                                            ...
                                                            data-toggle="modal"
                                                            data-target="#descModal{{ $production->id }}"
                                                            title="Voir description">
                                                        <i class="fa fa-eye text-muted"></i>
                                                    </button>

                                                    @if($production->attachment)
                                                        <a href="{{ asset('storage/' . $production->attachment) }}"
                                                           target="_blank"
                                                           class="btn btn-sm btn-light rounded-circle mx-1 text_orange"
                                                    ...
                                                    @if($production->status === 'pending' || $production->status === 'rejected')
                                                        <a href="{{ route('member.productions.edit', $production->uuid) }}"
                                                           class="btn btn-sm btn-light rounded-circle mx-1 text-info"
                                                           title="Modifier">
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-center py-5">
                                                <div class="py-4">
                                                    ...
                                                    <p class="small text-muted">Commencez par soumettre votre premier
                                                        projet de production.</p>
                                                    <a href="{{ route('member.productions.create') }}"
                                                       class="btn btn-sm btn-outline-orange rounded-pill mt-3 px-4">
                                                        Soumettre un projet
                                                    </a>
                                                </div>
                                            </td>
                ...
                <div class="modal-content border-0 shadow-lg" style="border-radius: 15px;">
                    ...
                    <div class="modal-body p-4 text-left">
                        ...
                        @if($production->admin_note)
                            ...
                            <div class="p-3 rounded bg-light border-left border-warning"
