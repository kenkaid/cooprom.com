...
<section class="page-title" style="background-image: url({{ asset('assets/front/images/background/11.jpg') }});">
    <div class="auto-container">
        ...
        <ul class="page-breadcrumb">
            ...
            <li><a href="{{ route('member.productions.index') }}">Productions</a></li>
            <li>Modifier</li>
        </ul>
    </div>
</section>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="inner-column bg-white p-4 rounded shadow-sm">
                    ...
                    <div class="contact-form default-form">
                        <form method="post" action="{{ route('member.productions.update', $production->uuid) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            @include('front.member.productions._form')

                            <div class="col-lg-12 col-md-12 col-sm-12 form-group text-right">
                                <a href="{{ route('member.productions.index') }}" class="theme-btn btn-style-two mr-2"><span class="btn-title">Annuler</span></a>
