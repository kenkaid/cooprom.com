...
@section('title', 'Nouveau Projet de Production - COOPROM')
...
@section('content')
    ...
    @php
        ...
        $breadcumb_table = ['Soumettre un projet'];
    @endphp
            ...
            <div class="col-lg-9 col-md-12 col-12">
                <div class="inner-column bg-white p-4 rounded shadow-sm">
                    ...
                    <div class="contact-form default-form">
                        <form method="post" action="{{ route('member.productions.store') }}" enctype="multipart/form-data">
                            @csrf
...
<script>
    ...
    // Pré-remplir l'input si du vieux contenu existe
    ...
    function uploadWithProgress(formData) {
        ...
        submitBtn.innerHTML = '<span class="btn-title">Envoi en cours...</span>';
        ...
        function resetSubmitState() {
            ...
            submitBtn.innerHTML = '<span class="btn-title">Envoyer la demande</span>';
