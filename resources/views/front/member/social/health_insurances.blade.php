...
@section('content')
    ...
    @php
        ...
        $breadcumb_table = ['member.social.index' => 'Aide Sociale', 'Assurances'];
    @endphp
                                ...
                                <div class="card border-0 shadow-sm rounded-lg h-100 overflow-hidden">
                                    <div class="card-body p-4">
                                        <div class="d-flex align-items-center mb-3">
                                            <div
                                                class="bg-light text-info rounded-circle d-flex align-items-center justify-content-center mr-3"
                                            ...
                                            <div>
                                                ...
                                                <span
                                                    class="badge badge-light border text-muted px-2 py-1 small">{{ $insurance->insurance_type }}</span>
                                            </div>
                                        </div>
                                        ...
                                        @if($insurance->coverage_details)
                                            <div class="bg-light p-3 rounded mb-4">
                                                <h6 class="font-weight-bold small mb-2"><i
                                                        class="fa fa-shield-alt mr-2 text-info"></i> Couverture :</h6>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-auto">
                                            @if($insurance->external_link)
                                                <a href="{{ $insurance->external_link }}" target="_blank"
                                                   class="btn btn-sm btn-outline-info rounded-pill px-4">Plus
                                                    d'infos</a>
                                            @endif
                        ...
                        @empty
                            <div class="col-12">
                                <div class="card border-0 shadow-sm rounded-lg p-5 text-center">
                                    ...
                                    <p class="small text-muted">Revenez bientôt pour découvrir nos offres
                                        exclusives.</p>
                                </div>
                            </div>
                        @endforelse
