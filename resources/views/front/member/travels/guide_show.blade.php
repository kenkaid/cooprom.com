...
<section class="page-title" style="background-image: url({{ asset('assets/front/images/background/11.jpg') }});">
    <div class="auto-container">
        <h1>Guide Visa : {{ $guide->country }}</h1>
        <ul class="page-breadcrumb">
            <li><a href="/">Accueil</a></li>
            <li><a href="{{ route('member.dashboard') }}">Dashboard</a></li>
            <li><a href="{{ route('member.travels.guides') }}">Guides Visa</a></li>
            <li>{{ $guide->country }}</li>
        </ul>
    </div>
</section>
                ...
                <div class="card border-0 shadow-sm rounded-lg overflow-hidden">
                    <div class="card-header bg-white p-4 border-0 d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <span class="badge badge-light text-secondary">{{ $guide->visa_type ?? 'Tous visas' }}</span>
                        </div>
                        <a href="{{ route('member.travels.guides') }}" class="btn btn-sm btn-light rounded-pill px-3">
                    ...
                    <div class="card-body p-4">
                        @if($guide->description)
                            <div class="description-box mb-4 p-3 bg-light rounded">
                                <h6 class="font-weight-bold text-orange mb-2"><i class="fa fa-info-circle mr-2"></i>Introduction</h6>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                <div class="info-block h-100 p-4 border rounded shadow-sm bg-white">
                                    <h6 class="font-weight-bold text-orange mb-3"><i class="fa fa-file-alt mr-2"></i>Documents requis</h6>
                            ...
                            <div class="col-md-6 mb-4">
                                <div class="info-block h-100 p-4 border rounded shadow-sm bg-white">
                                    <h6 class="font-weight-bold text-orange mb-3"><i class="fa fa-tasks mr-2"></i>Procédure à suivre</h6>
                                    <div class="content-list small">
                        ...
                        @if($guide->useful_links)
                            <div class="links-box mt-2 p-3 border rounded bg-light">
                                <h6 class="font-weight-bold mb-2"><i class="fa fa-link mr-2 text-primary"></i>Liens utiles</h6>
                        ...
                        <div class="mt-5 p-4 bg_orange text-white rounded shadow-sm">
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    ...
                                    <p class="mb-0 small">Nos conseillers vous aident dans la constitution de votre dossier.</p>
                                </div>
                                <div class="col-md-4 text-md-right mt-3 mt-md-0">
                                    <a href="{{ route('member.travels.create_visa', ['country' => $guide->country]) }}" class="btn btn-light rounded-pill px-4 font-weight-bold text-orange">
                                        Faire une demande
                                    </a>
                                </div>
                            </div>
