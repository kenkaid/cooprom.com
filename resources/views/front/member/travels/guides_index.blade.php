            ...
            <div class="col-lg-9 col-md-12 col-12">
                <div class="card border-0 shadow-sm rounded-lg overflow-hidden">
                    <div class="card-header bg-white p-4 border-0">
                        ...
                        <p class="text-muted small mb-0">Retrouvez toutes les informations nécessaires pour vos formalités de visa.</p>
                    </div>
                            ...
                            @forelse($guides as $guide)
                                <div class="col-md-6 mb-4">
                                    <div class="guide-card p-4 border rounded shadow-sm h-100">
                                        ...
                                        <a href="{{ route('member.travels.guide_show', $guide->uuid) }}" class="btn btn-sm btn-outline-orange rounded-pill px-4">
                                            Consulter le guide
                                        </a>
                                    </div>
                                </div>
