...
@section('content')
    ...
    @php
        ...
        $title = 'Mes Voyages & Visas';
        $breadcumb_table = ['Voyages'];
    @endphp
                ...
                <div class="col-lg-9 col-md-12 col-12">
                    <div class="card border-0 shadow-sm rounded-lg overflow-hidden">
                        <div
                            ...
                            <a href="{{ route('member.travels.create_visa') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                @if($visa->status === 'pending')
                                                    <a href="{{ route('member.travels.edit_visa', $visa->uuid) }}"
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center py-5">
                                                <div class="py-4">
                                                    ...
                                                    <p class="small text-muted">Prévoyez votre prochaine mobilité
                                                        internationale avec la COOPROM.</p>
                                                    <a href="{{ route('member.travels.create_visa') }}"
