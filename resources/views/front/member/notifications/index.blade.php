...
@section('content')
    ...
    @php
        $image_link = 'assets/front/images/resource/members/notification.jpeg';
        $title = 'Mes Notifications';
        $breadcumb_table = ['Notifications'];
    @endphp
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="list-group list-group-flush">
                                @forelse($notifications as $notification)
                                    <div
                                        class="list-group-item list-group-item-action p-4 border-bottom {{ $notification->unread() ? 'bg-light-info' : '' }}">
                                        <div class="d-flex w-100 justify-content-between align-items-start">
                                            <div class="d-flex align-items-start">
                                                <div
                                                    class="notification-icon mr-3 rounded-circle d-flex align-items-center justify-content-center {{ $notification->unread() ? 'bg-info text-white' : 'bg-light text-muted' }}"
                                ...
                                @empty
                                    <div class="text-center py-5">
                                        <div class="py-4">
                                            ...
                                            <p class="small text-muted">Vous serez informé ici des mises à jour de vos
                                                demandes.</p>
                                        </div>
                                    </div>
                                @endforelse
