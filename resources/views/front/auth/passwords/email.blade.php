...
@section('title', 'Récupération de mot de passe - COOPROM')
                                ...
                                <div class="mb-4">
                                    <div class="form-floating-creative group">
                                        ...
                                        <div class="input-group-modern d-flex align-items-center border-bottom pb-2 transition-all">
                                            ...
                                            <input type="email" name="email" class="form-control-minimal" placeholder="votre@email.com" value="{{ old('email') }}" required autofocus>
                                        </div>
                                    </div>
                                </div>

                                <button type="submit" class="theme-btn btn-style-one w-100 py-3 shadow-xl border-0 mb-4">
                                    <span class="btn-title font-weight-bold">ENVOYER LE LIEN <i class="fas fa-paper-plane ml-2"></i></span>
                                </button>

                                <div class="text-center">
                                    <a href="{{ route('login') }}" class="text-muted small font-weight-bold text-decoration-none">
