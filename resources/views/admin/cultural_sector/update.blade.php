...
<div class="row">
    <div class="col-xl-12 mx-auto">
        <h6 class="mb-0 text-uppercase">Modifier le Secteur Culturel</h6>
        <hr/>
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.cultural-sectors.update', $sector->uuid) }}" method="POST">
                    @csrf
                    @method('PUT')
                    @include('admin.cultural_sector._form')
                    <div class="mt-3">
                        <button type="submit" class="btn btn-outline-primary px-5 radius-30">Mettre à jour</button>
