                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center gap-3 fs-6">
                                <a href="{{ route('admin.partners.show', $partner->uuid) }}" class="text-primary" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Voir">
                                    <i class="bi bi-eye-fill"></i>
                                </a>
                                <a href="{{ route('admin.partners.edit', $partner->uuid) }}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Modifier">
                                    <i class="bi bi-pencil-fill"></i>
                                </a>
                                <form action="{{ route('admin.partners.destroy', $partner->uuid) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer ce partenaire ?')" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
